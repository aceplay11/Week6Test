...
public class NYHighSchoolsResponse implements Parcelable
{
    ...
    public final static Parcelable.Creator<NYHighSchoolsResponse> CREATOR = new Creator<NYHighSchoolsResponse>() {


        @SuppressWarnings({
            "unchecked"
        })
        public NYHighSchoolsResponse createFromParcel(Parcel in) {
            return new NYHighSchoolsResponse(in);
        }

        public NYHighSchoolsResponse[] newArray(int size) {
            return (new NYHighSchoolsResponse[size]);
        }

    }
    ;

    protected NYHighSchoolsResponse(Parcel in) {
